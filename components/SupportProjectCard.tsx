    ...
    <>
      <section className="mx-auto max-w-7xl px-4 py-12 lg:px-6">
        <div className="glass-card relative overflow-hidden p-0">
          <div className="absolute left-[-5rem] top-[-4rem] h-44 w-44 rounded-full bg-cyan-400/16 blur-3xl" />
          <div className="absolute bottom-[-4rem] right-[-2rem] h-48 w-48 rounded-full bg-primary/16 blur-3xl" />
          ...
          <div className="relative grid gap-8 p-6 lg:grid-cols-[1.15fr_0.85fr] lg:p-8">
            <div className="space-y-5">
              ...
              <div>
                <h2 className="max-w-2xl text-3xl font-semibold leading-tight text-white md:text-4xl">
                  Suka dengan arah baru ClipForge AI?
                  <span className="text-gradient block">Bantu project ini terus berkembang.</span>
                </h2>
                <p className="mt-4 max-w-2xl text-base leading-7 text-white/65">
                  Dukungan kamu ikut membantu pengembangan fitur, perbaikan alur kerja, dan biaya maintenance. Kalau
                  project ini terasa berguna, kamu bisa support cepat lewat QRIS.
                </p>
              </div>

              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  "Bisa dipindai dari hampir semua aplikasi QRIS",
                  "Cocok untuk support cepat tanpa proses panjang",
                  "Membantu maintenance, eksperimen, dan rilis fitur"
                ].map((item) => (
            ...
            <div className="relative">
              <div className="relative mx-auto max-w-sm overflow-hidden rounded-[30px] border border-white/10 bg-slate-950/70 p-4 shadow-[0_30px_100px_rgba(0,0,0,0.45)]">
                <div className="absolute inset-x-6 top-0 h-20 bg-gradient-to-r from-cyan-400/16 via-transparent to-primary/16 blur-2xl" />
                <div className="relative">
                  <div className="mb-4 flex items-center justify-between gap-4">
                    <div>
                      <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-white/35">Support Creator</p>
                      <p className="mt-1 text-xl font-semibold text-white">Zens Store</p>
                      <p className="text-sm text-white/50">Scan QRIS untuk mendukung pengembangan</p>
                    </div>
                  ...
                  <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-white/60">
                    Klik preview atau tombol di kiri untuk membuka QRIS dan melakukan scan dari perangkat lain.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-md">
          <div className="relative w-full max-w-2xl overflow-hidden rounded-[32px] border border-white/10 bg-[#0b1017] p-4 shadow-[0_32px_120px_rgba(0,0,0,0.6)] md:p-6">
            ...
            <div className="mb-5 pr-12">
              ...
              <h3 className="mt-2 text-2xl font-semibold text-white">Scan dan dukung kelanjutan ClipForge AI</h3>
              <p className="mt-2 text-sm leading-6 text-white/60">
                Gunakan aplikasi e-wallet atau mobile banking yang mendukung QRIS. Kalau lebih nyaman, buka gambar
                penuh lalu scan dari perangkat lain.
              </p>
            </div>
