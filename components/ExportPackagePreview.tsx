  ...
  return (
    <Card className="space-y-3">
      <div>
        ...
        <p className="text-sm text-white/55">Semua artefak disusun sebagai bundle yang lebih gampang dicek sebelum dikirim.</p>
      </div>
      ...
      <div className="space-y-2">
        {artifacts.map((artifact) => {
          ...
          return (
            <div
              key={artifact.name}
              className="grid gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 sm:grid-cols-[1fr_auto] sm:items-center"
            >
